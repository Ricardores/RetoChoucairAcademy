...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanRicWantsToLearnAutomationAtTheAcademyChoucair
            (List<AcademyChoucairData> academyChoucairData) throws Exception {
        OnStage.theActorCalled("Ric").wasAbleTo(OpenUp.thePage(),
    ...
    public void heSearchForTheCourseISTQBTestAutomationEngineerOnTheChoucairAcademyPlataform
            (List<AcademyChoucairData> academyChoucairData) throws Exception{
    ...
    public void heFindsTheCourseCalledResourcesISTQBTestAutomationEngineer
            (List<AcademyChoucairData> academyChoucairData) throws Exception {
